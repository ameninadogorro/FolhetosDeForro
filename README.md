FolhetosDeForró é um aplicativo que permite aos usuários gerenciar sua biblioteca pessoal de cordéis, oferecendo recursos de cadastro, atualização, exclusão e visualização detalhada dos itens.
Escopo do Projeto:
